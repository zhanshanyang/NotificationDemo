package com.yzs.demo.notificationdemo.notifications;
...
public class NotificationsReceiveActivity extends AppCompatActivity {

    private static final String TAG = "SevenNLS";
    private static final String TAG_PRE = "["+NotificationsReceiveActivity.class.getSimpleName()+"] ";
    ...
    private void createNotification(Context context) {
        ...
        ncBuilder.setSmallIcon(R.drawable.jd_icon);
