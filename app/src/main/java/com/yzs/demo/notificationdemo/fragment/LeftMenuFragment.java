package com.yzs.demo.notificationdemo.fragment;
...
public class LeftMenuFragment extends ListFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < SIZE_MENU_ITEM; i++) {
            menuItem = new MenuItem(getResources().getStringArray(R.array.array_left_menu)[i], false, R.drawable.ic_card_user_default, R.drawable.ic_launcher_360_selected);
            mItems[i] = menuItem;
        }
    }
